...
const RegisterPetPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      images.forEach((img, i) => {
        payload.append(`images[${i}]`, img);
      });

      await axios.post(`${API_URL}/pets/adoption/create/`, payload, {
        headers: {
      ...
      <div className="success-wrapper">
        ...
        >
          ...
          <div className="success-actions">
            <Link to="/AdoptPage" className="primary-btn">
              Browse All Pets
            </Link>
            <Link to="/UserDashboard" className="ghost-btn">
              Go to Dashboard
            </Link>
  ...
  return (
    <div className="register-page">
      <Link to="/AdoptPage" className="back-link">
        <ArrowLeft size={16} /> Back to Adoption </Link>
        ...
        <aside className="register-sidebar">
          <div className="sidebar-card">
            ...
            <div className="health-tip">
              ...
              <span>Upload vaccination records to build trust</span>
            </div>

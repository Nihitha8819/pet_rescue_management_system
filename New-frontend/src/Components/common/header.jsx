...
import {Search, MapPin, Heart, ArrowRight, ShieldCheck, Users, Clock, CheckCircle2 } from "lucide-react";
import { useNavigate } from "react-router-dom";
import './header.css'

const stats = [
  { label: "Pets Adopted", value: "2,500+", icon: Heart },
  { label: "Lost Pets Found", value: "1,200+", icon: Search },
...
const Header = () => {
    ...
    <div className="scection__container header__container">
      ...
      <div className="header__image">
        <img src="paw1.png" alt="header-bg" class="header__image-bg" />
